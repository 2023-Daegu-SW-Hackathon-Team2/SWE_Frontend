    ...
    <div className={`cart`}>
      <div className='cart-container'>
        <div className= 'cart-head'>
          ...
          <div className='cart-head-deliver'>배송비</div>
        </div>
          ...
          {data.map((item, index) => (
            <div key={index} className='cart-row'>
              ...
              <div className='cart-row-num'>
                ...
                <div className='cart-row-num-text'>{item.num}</div>
                <button className='cart-row-num-button'>
              ...
              <div className='cart-row-deliver'>{`${item.deliver}원`}</div>
            </div>
          ))}
        </div>
      </div>
      <div className='total-container'>
        <div className='product-total'>
          ...
          <div className='product-total-money'>10,000</div>
        </div>
        <div className='product-total'>
          <div className='product-total-name'>배송비</div>
          <div className='product-total-money'>25,000</div>
        </div>
        <div className='product-money'>
          <div className='product-money-name'>총합</div>
          <div className='product-money-money'>35,000</div>
        </div>
